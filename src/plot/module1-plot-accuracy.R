...
#
#
source("src/plot/function.test_accuracy.R")
source("src/plot/function.plot_accuracy.R")
source("src/plot/function.plot_hqvariants.R")
#
#### import dosage ####
# PID
...
#### plot accuracy ####
p3 <- plot_accuracy(x=ls(pattern="r2_"))
...
p4 <- plot_hqvariants(x=ls(pattern="rsq_"))
OUTPUT="output/plot-table/high-quality-variants_5-ref-panel.png"
